...
selected_day = '2013-08-11'

% ---------------------  Atmospheric Readings ----------------------------
% Pyranometer
%db.prepareStatement(['select * from id_16663 order by timestamp desc limit ',lim]);
db.prepareStatement(['select * from id_16663 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);
...
% % % %Wind Speed
% db.prepareStatement(['select * from id_16637 order by timestamp desc limit ',500]);
% % db.prepareStatement('select * from id_16637 where timestamp between "2013-08-29 00:00" and "2013-08-29 23:59"  limit 1e8');
...
db.prepareStatement(['select * from id_16636 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);
...
db.prepareStatement(['select * from id_16525 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);
...
%Current
db.prepareStatement(['select * from id_16534 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);

I_result = db.query();

%from past to now
dt_I = datenum(I_result.timestamp(end:-1:1) );
I  = -1*I_result.value(end:-1:1) ;  


%Energy Active Export
db.prepareStatement(['select * from id_16524 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);

E_export_result = db.query();

%from past to now
dt_E_export = datenum(E_export_result.timestamp(end:-1:1) );
E_export  = -1*E_export_result.value(end:-1:1) ;  



%Energy Active Import
db.prepareStatement(['select * from id_16523 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);

E_import_result = db.query();

%from past to now
dt_E_import = datenum(E_import_result.timestamp(end:-1:1) );
E_import  = -1*E_import_result.value(end:-1:1) ;  


%Frequency
db.prepareStatement(['select * from id_16535 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);

Freq_result = db.query();

%from past to now
dt_Freq = datenum(Freq_result.timestamp(end:-1:1) );
Freq  = -1*Freq_result.value(end:-1:1) ;  

%Power Factor
db.prepareStatement(['select * from id_16536 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);

PF_result = db.query();

%from past to now
dt_PF = datenum(PF_result.timestamp(end:-1:1) );
PF  = -1*PF_result.value(end:-1:1) ;  



%V(L3)
db.prepareStatement(['select * from id_16531 where timestamp between "',selected_day,' 00:00" and "',selected_day,' 23:59"  limit 10000000000000']);

V_result = db.query();

%from past to now
dt_V = datenum(V_result.timestamp(end:-1:1) );
V  = -1*V_result.value(end:-1:1) ;  
...
subplot(4,2,2)
plot(dt_E_import,E_import)

subplot(4,2,3)
plot(dt_E_export,E_export)
