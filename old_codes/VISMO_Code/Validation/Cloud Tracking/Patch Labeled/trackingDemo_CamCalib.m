...
multiObjectTrackingCV_CamCalib(video_name,0,1,ocam_model,ecam_model,model3D,image_mask,sunPattern,modelImage,live,track,timeSeriesGHI,timeSeriesPV,timeSeriesTemp);