...
fprintf('Number of rules in the tree: %d\n', nRules);
if ~isempty(vars)
    list = '';
    for i = 1:length(vars)
    ...
    fprintf('Number of original input variables in the tree: %d (%s)\n', length(vars), list);
else
    fprintf('Number of original input variables in the tree: 0\n');
end
return
