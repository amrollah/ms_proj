%% pvl_erbs
% Estimate Direct Normal Irradiance from Global Horizontal Irradiance using the ERBS model
%
%% Syntax
% |DNI = pvl_erbs(GHI,Z, doy)|
%
%% Description
% The ERBS algorithm converts global horizontal irradiance to diffuse
...
DNI_model = pvl_erbs(GHI,90-AppSunEla, dayofyear);
...
xlim([0 25])
legend('DNI (ERBS Model)','DNI (TMY3)','Location','NE')
xlabel('Hour of Day')
ylabel('Irradiance (W/m^2)')
title('Albuquerque Direct Normal Irradiance Comparison - Aug 6','FontSize',14)
%% References
%%
% * [1] Erbs 1982 "Estimation of the diffuse radiation fraction for
%   hourly, daily and monthly-average global radiation" Eq. 1
%
%% See also
