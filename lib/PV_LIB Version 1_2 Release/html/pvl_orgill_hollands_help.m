%% pvl_orgill_hollands
% Estimate Direct Normal Irradiance from Global Horizontal Irradiance using the ORGILL_HOLLANDS model
%
%% Syntax
% |DNI = pvl_orgill_hollands(GHI,Z, doy)|
%
%% Description
% The ORGILL_HOLLANDS algorithm converts global horizontal irradiance to diffuse
...
DNI_model = pvl_orgill_hollands(GHI,90-AppSunEla, dayofyear);
...
xlim([0 25])
legend('DNI (O&H Model)','DNI (TMY3)','Location','NE')
xlabel('Hour of Day')
