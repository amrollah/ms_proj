%% pvl_louche
% Estimate Direct Normal Irradiance from Global Horizontal Irradiance using the LOUCHE model
%
%% Syntax
% |DNI = pvl_louche(GHI,Z, doy)|
%
%% Description
% The LOUCHE algorithm converts global horizontal irradiance to direct
...
DNI_model = pvl_louche(GHI,90-AppSunEla, dayofyear);
