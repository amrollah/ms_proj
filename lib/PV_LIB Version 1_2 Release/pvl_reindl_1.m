...
function [DNI, Kt] = pvl_reindl_1(GHI,Z, doy)
% PVL_REINDL_1 Estimate Direct Normal Irradiance from Global Horizontal 
% Irradiance using the REINDL_1 model
%
% Syntax
% [DNI, Kt] = pvl_reindl_1(GHI,Z, doy)
%
%
% Description
%   The Reindl_1 algorithm converts global horizontal irradiance to direct
