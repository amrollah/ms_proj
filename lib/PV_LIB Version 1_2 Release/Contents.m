...
%   pvl_erbs               - Determine DNI from GHI using the ERBS model
%   pvl_louche             - Determine DNI from GHI using the LOUCHE model
%   pvl_orgill_hollands    - Determine DNI from GHI using the Orgill and Hollands model
%   pvl_reindl_1           - Determine DNI from GHI using the Reindl_1 model
%   pvl_reindl_2           - Determine DNI from GHI using the Reindl_2 model
%   pvl_clearsky_haurwitz  - Determine clear sky GHI from Haurwitz model
%   pvl_clearsky_ineichen  - Determine DNI from GHI using the Reindl_2 model
...
%   pvl_adrinverter        - Converts DC power and voltage to AC power using Anton Driesse's Grid-Connected PV Inverter