...
function [DNI, Kt] = pvl_orgill_hollands(GHI,Z, doy)
% PVL_ORGILL_HOLLANDS Estimate Direct Normal Irradiance from Global Horizontal 
% Irradiance using the ORGILL_HOLLANDS model
%
% Syntax
% [DNI, Kt] = pvl_orgill_hollands(GHI,Z, doy)
%
%
% Description
%   The orgill_hollands algorithm converts global horizontal irradiance to direct
