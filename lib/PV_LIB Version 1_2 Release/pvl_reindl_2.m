...
function [DNI, Kt] = pvl_reindl_2(GHI,Z, doy)
% PVL_REINDL_2 Estimate Direct Normal Irradiance from Global Horizontal 
% Irradiance using the REINDL_2 model
%
% Syntax
% [DNI, Kt] = pvl_reindl_2(GHI,Z, doy)
%
%
% Description
%   The Reindl_2 algorithm converts global horizontal irradiance to direct
